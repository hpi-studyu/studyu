...
-- todo create another study for test_creator_2
...
-- todo Limitation or privacy issue?
SELECT diag( title ) FROM public.study;
...
SELECT is(title, 'Lower back pain', 'Check if a user can only retrieve his study') FROM public.study;
