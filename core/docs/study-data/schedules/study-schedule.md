...
| `sequenceCustom`  | `String`                                            | Yes      | `'ABAB')..numberOfCycles = (json['numberOfCycles'] as num).toInt()..phaseDuration = (json['phaseDuration'] as num).toInt()..includeBaseline = json['includeBaseline'] as bool..sequence = $enumDecode(_$PhaseSequenceEnumMap, json['sequence'])` | Custom phase sequence string (e.g. `AABB`). Only used when `sequence` is `customized`.        |
