...
StudyDetailsBase _$StudyDetailsBaseFromJson(Map<String, dynamic> json) {
  return StudyDetailsBase()
    ...
    ..eligibility =
        (json['eligibility'] as List).map((e) => EligibilityCriterion.fromJson(e as Map<String, dynamic>)).toList()
    ..consent = (json['consent'] as List).map((e) => ConsentItem.fromJson(e as Map<String, dynamic>)).toList()
    ..interventionSet = InterventionSet.fromJson(json['interventionSet'] as Map<String, dynamic>)
...
Map<String, dynamic> _$StudyDetailsBaseToJson(StudyDetailsBase instance) => <String, dynamic>{
