...
class ParseStudy extends ParseObject implements ParseCloneable, StudyBase {
  ...
  static const keyParticipantCount = 'participantCount';

  int get participantCount => get<int>(keyParticipantCount);

  set participantCount(int participantCount) => set<int>(keyParticipantCount, participantCount);
