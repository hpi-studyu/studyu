...
ChoiceQuestion _$ChoiceQuestionFromJson(Map<String, dynamic> json) => ChoiceQuestion()
  ...
  ..conditional = json['conditional'] == null
      ? null
      : QuestionConditional<List<String>>.fromJson(json['conditional'] as Map<String, dynamic>)
