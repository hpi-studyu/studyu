...
Study _$StudyFromJson(
  Map<String, dynamic> json,
) => Study(json['id'] as String, json['user_id'] as String)
  ...
  ..eligibilityCriteria = Study._eligibilityCriteriaFromJson(
    json['eligibility_criteria'],
  )
  ..consent =
      (json['consent'] as List<dynamic>?)
  ...
  ..results = json['results'] == null
      ? []
      : Study._studyResultsFromJson(json['results'])
  ..collaboratorEmails =
