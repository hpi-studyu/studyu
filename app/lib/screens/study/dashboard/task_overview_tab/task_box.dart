...
class _TaskBoxState extends State<TaskBox> {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      elevation: 2,
      child: InkWell(
        onTap: completed || !widget.completionPeriod.contains(nowTime) || !context.read<AppState>().isPreviewSkipping ? () {} : _navigateToTaskScreen,
        child: Row(
          children: [
            Expanded(
              child: ListTile(
            ...
            if (widget.completionPeriod.contains(nowTime) || context.read<AppState>().isPreviewSkipping)
              RoundCheckbox(
