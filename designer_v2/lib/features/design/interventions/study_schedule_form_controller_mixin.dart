...
mixin StudyScheduleControls {
  ...
  // add a form group for the ABAB sequence
  // final alternatingSequence = FormGroup({
  //   'cycles': FormControl<int>(value: 1, validators: [
  //     Validators.required,
  //     Validators.min(1),
  //     Validators.max(9),
  //   ]),
  //   'cycle_duration': FormControl<int>(value: 4),
  // });

  final FormControl<int> demoControl =
      FormControl(value: 1, validators: [Validators.required]);


  // final sequenceArray = FormArray([
  //   FormGroup({
  //     'cycles': FormControl<int>(value: 1, validators: [
  //       Validators.required,
  //       Validators.min(1),
