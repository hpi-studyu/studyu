...
class InterventionFormView extends ConsumerWidget {
        ...
        FormTableLayout(
            rows: [
              ...
              FormTableRow(
                ...
                labelHelpText: "TODO Intervention task description help text".hardcoded,
                input: ReactiveTextField(
              ...
              return ReactiveFormArray(
                ...
                builder: (context, formArray, child) {
                  return FormArrayTable<InterventionTaskFormViewModel>(
                    ...
                    rowTitle: (viewModel) => viewModel.formData?.taskTitle ?? 'Missing item title'.hardcoded,
                    emptyIcon: Icons.content_paste_off_rounded,
                    emptyTitle: "No treatments defined".hardcoded,
                    emptyDescription: "You must define at least one task for your participants to complete during this intervention phase".hardcoded,
                  );
                },
              );
            }
  ...
  _showSidesheetWithArgs(
      ...
      WidgetRef ref)
  {
    final interventionTaskFormViewModel = ref.read(
    ...
    showFormSideSheet<InterventionTaskFormViewModel>(
      ...
      formViewBuilder: (formViewModel) => InterventionTaskFormView(
